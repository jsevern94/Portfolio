        ...
        return (
            <div>
                ...
                <div style={styles.cards}>
                    <ProjectCard title='Mongo Web Scraper' image='/images/mongo-scraper.PNG' deployedLink='https://calm-beach-78845.herokuapp.com/' code='https://github.com/jsevern94/news-forum'>Scrape articles from the Wall Stree Journal and comment on them to join in a discussion with other users.</ProjectCard>
